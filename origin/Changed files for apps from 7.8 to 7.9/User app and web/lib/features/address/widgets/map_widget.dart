    ...
    return SizedBox(
      ...
      child: ClipRRect(
        ...
        child: Stack(
          ...
          Positioned(
            bottom: ResponsiveHelper.isMobile() ? 10 : 70,
            right: ResponsiveHelper.isMobile() ? 0 : -10,
            child: InkWell(
            ...
            child: InkWell(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => SelectLocationScreen(googleMapController: locationProvider.mapController),
                ));
              },
              child: Container(

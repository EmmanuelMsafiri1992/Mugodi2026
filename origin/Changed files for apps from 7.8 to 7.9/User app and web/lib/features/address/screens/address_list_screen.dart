                  ...
                  child: Column(
                    ...
                    children: [
                      ResponsiveHelper.isDesktop(context) ? Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraLarge),
                        child: Center(child: Text("address_list".tr, style: poppinsSemiBold.copyWith(fontSize: Dimensions.fontSizeLarge))),
                      ) : const SizedBox(),
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          InkWell(
                            onTap:() {
                              ...
                              RouteHelper.getAddAddressRoute('address', 'add', AddressModel());
                            },
                            child: Container(
                              ...
                              child: Row(children: [
                                Icon(Icons.add, color: ResponsiveHelper.isDesktop(context) ? Colors.white : Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6)),
                      ...
                      ) :  NoDataWidget(title: getTranslated('no_address_found', context), isFooter: false,),
                    ],
                  ),
                ))),

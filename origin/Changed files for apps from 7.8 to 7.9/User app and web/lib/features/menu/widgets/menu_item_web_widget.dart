        ...
        child: Column(
          ...
          children: [
            menu.iconWidget != null ? menu.iconWidget! : CustomAssetImageWidget(
              ...
              color: (menu.title == getTranslated(isLogin ? 'log_out' : 'login', context)) && isLogin ? Theme.of(context).colorScheme.error.withValues(alpha: 0.7) : Theme.of(context).textTheme.bodyLarge?.color,
            ),

...
class TitleWithTimeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isFlashDealScreen = GoRouter.of(context).state.uri.toString().contains(ProductType.flashSale);
          ...
          return flashDealProvider.flashDealModel != null ? ResponsiveHelper.isDesktop(context) && !isDetailsPage! ? Column(children: [
              ...
              child: Row(children: [
                Text(
                  ...
                  style: ResponsiveHelper.isDesktop(context)
                      ?  poppinsRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor) : poppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor.withValues(alpha: 0.8)),
                ),
                Padding(
            ...
            child: Column(children: [
              ...
              Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Container(
                  height: 50,  color: Theme.of(context).shadowColor.withValues(alpha: 0.2),
